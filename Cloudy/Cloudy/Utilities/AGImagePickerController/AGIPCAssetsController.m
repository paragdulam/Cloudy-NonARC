...
//    [movePath addQuadCurveToPoint:self.view.center
//                     controlPoint:CGPointMake(self.view.center.x, icon.center.y)];
//    
...
//    
//    [icon.layer setPosition:CGPointMake(self.view.center.x, icon.center.y)];
