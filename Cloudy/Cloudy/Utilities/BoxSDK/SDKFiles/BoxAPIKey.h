...
/*
 ...
 The API calls require an API_KEY - see below to replace it. You can get this API key from http://developers.box.net/
...
static const NSString * BOX_API_KEY = @"ux3ux0v2rl17tppcfry7ddnuj57h3bl8";
